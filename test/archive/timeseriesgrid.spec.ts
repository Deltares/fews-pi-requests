...
import {TimeSeriesGridFilter, DocumentFormat} from '../../src/interfaces'
...
describe("archive/locations", function() {
  ...
  it("gets called when done", async function() {
    mock.get("https://mock.dev/fewswebservices/rest/fewspiservice/v1/timeseries/grid?documentFormat=PI_JSON&layers=-knmi_harmonie40--air_pressure_fixed_height-&x=469168.1587130217&y=6773416.739869252&startTime=2020-12-22T21%3A00%3A00.000Z&endTime=2020-12-22T21%3A00%3A00.000Z&bbox=233081.51067565128%2C6437014.8860724205%2C1028684.8666990183%2C6955886.640000704&importFromExternalDataSource=true&externalForecastTime=2020-12-20T21%3A00%3A00.000Z", {
      status: 200,
