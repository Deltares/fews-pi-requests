...
describe('archive/productsMetadata', function () {
  it('gets productsMetadata', async function () {
    fetchMock.route(
      'https://mock.dev/fewswebservices/rest/fewspiservice/v1/archive/productsmetadata?startForecastTime=2022-12-12T20%3A30%3A00Z&endForecastTime=2022-12-14T20%3A30%3A00Z&attribute(area_id)=meren',
      {
        status: 200,
