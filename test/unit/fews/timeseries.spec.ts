...
describe('timeseries', function () {
  it('timeseries json response', async function () {
    ...
    if (
      results?.timeSeries?.length === 4 &&
      results?.timeSeries[0].events?.length === 5
    ) {
