...
describe('timeseries/topology/actions', function () {
  it('gets timeseries from topology actions response', async function () {
    fetchMock.get(
      'https://mock.dev/fewswebservices/rest/fewspiservice/v1/timeseries/topology/actions?documentFormat=PI_JSON&startTime=2020-12-22T21%3A00%3A00.000Z&endTime=2020-12-22T21%3A00%3A00.000Z&nodeId=testNode&timeSeriesDisplayIndex=0&downloadAsFile=true',
      {
        status: 200,
