...
describe('timeseries/edit', function () {
  it('post events using time series index and location id', async function () {
    fetchMock.post(
      'https://mock.dev/fewswebservices/rest/fewspiservice/v1/timeseries/edit?timeSeriesSetIndex=1&locationId=2',
      {
        status: 200,
        body: 'uploaded',
      },
  ...
  it('post multiple events using time series index and location id and ensemble', async function () {
    fetchMock.post(
      'https://mock.dev/fewswebservices/rest/fewspiservice/v1/timeseries/edit?timeSeriesSetIndex=3&locationId=4&ensembleId=1&ensembleMemberId=2',
      {
        status: 200,
        body: 'uploaded',
      },
  ...
  it('post events using time series index and location id', async function () {
    fetchMock.post(
      'https://mock.dev/fewswebservices/rest/fewspiservice/v1/timeseries/edit?timeSeriesSetIndex=5&locationId=2',
      {
        status: 200,
        body: 'uploaded',
      },
  ...
  it('post events with relative url', async function () {
    ...
    const url =
      'rest/fewspiservice/v1/timeseries/edit?timeSeriesSetIndex=1&locationId=2'
    const results = await provider.postTimeSeriesEdit(url, timeSeries)
    expect(results).toStrictEqual('uploaded')
  })
})
