...
const piSchemas = [
  ...
  {
    url: `${config.url}/pi_rest_messages.json`,
    output: 'src/response/messages/messagesResponse.ts',
  },
  {
    url: `${config.url}/pi_rest_topics_messages_post_response.json`,
    output: 'src/response/messages/postMessageResponse.ts',
  },
  {
    url: `${config.url}/pi_rest_topics_messages_post.json`,
    output: 'src/requestParameters/postMessageBody.ts',
  },
]
